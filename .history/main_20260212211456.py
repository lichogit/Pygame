...
#chooses the correct head and tail sprites depending on the direction the  snake is moving
	def update_head_graphics(self):
		...
		if head_relation.x == 1 and head_relation.y == 0: 
			self.head = self.head_left
		elif head_relation.x == -1 and head_relation.y == 0: 
			self.head = self.head_right
		elif head_relation.x == 0 and head_relation.y == 1: 
	...
	def update_tail_graphics(self):
		...
		if tail_relation.x == 1 and tail_relation.y == 0: 
			self.tail = self.tail_left
		elif tail_relation.x == -1 and tail_relation.y == 0: 
			self.tail = self.tail_right
		elif tail_relation.x == 0 and tail_relation.y == 1: 
