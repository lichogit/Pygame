...
#if the previous and next block are in the same column, use the vertical body graphic. If they are in the same row, use the horizontal body graphic
		for index,block in enumerate(self.body):
			...
			if index == 0:
				...
				if previous_block.x == next_block.x:
					...
					#Depending on the positions of the previous and next block  use the correct corner sprites
				else:
